<x-app-layout>
    <div x-data="{ showContactForm: false }">
        <div class="p-8">
            ...
            <p class="mb-4">Вашият профил е неактивен. Моля, свържете се с администратор за повече информация.</p>
            <button class="bg-blue-500 text-white px-4 py-2 rounded-md" @click="showContactForm = true">Свържете се с администратор</button>
        </div>
        ...
        <div x-show="showContactForm" class="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-75" style="display: none">
            <div class="bg-white rounded-lg p-8 w-1/2">
                ...
                <form>
                    ...
                    <button class="bg-blue-500 text-white px-4 py-2 rounded-md">Изпрати</button>

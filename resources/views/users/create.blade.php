<x-app-layout>
    ...
    <div class="flex items-center justify-between px-6 py-8 mx-auto md:h-screen lg:py-0">
        ...
        <h2 class="mb-4 text-xl font-bold leading-tight tracking-tight text-gray-400 md:text-2xl">
            ИЛИ
        </h2>
        ...
        <div class="w-full p-6 bg-white rounded-lg shadow md:mt-0 sm:max-w-md sm:p-8">
            ...
            {!! Form::open(['route' => 'users.import', 'method' => 'POST', 'files' => true]) !!}
            <div>
                <div class="mb-5">
                    Можете да прикачите файл с потребители във формат .xlsx. За целта използвайте следния <a href="{{ route('download.template') }}" class="text-blue-600 underline">шаблон</a>:
                </div>

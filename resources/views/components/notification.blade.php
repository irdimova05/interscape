                ...
                <div class="p-4">
                    <div class="flex items-start">
                        ...
                        <div class="ml-3 w-0 flex-1 pt-0.5">
                            <p x-text="message.message" class="font-medium text-gray-900 text-md"></p>
                        </div>

        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-8 lg:py-12">
            ...
            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                ...
                <div class="w-full">
                    ...
                    {!! Form::number('salary', null, ['class'=>"bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"]) !!}

        ...
        <div class="p-8 bg-white shadow mt-24">
            <div class="grid grid-cols-1 md:grid-cols-3">
                <div class="grid grid-cols-3 text-center order-last md:order-first mt-20 md:mt-0">
                    <div>
                        <p class="font-bold text-gray-700 text-xl">wadawd</p>
                        <p class="text-gray-400">Курс</p>
                    </div>
                    <div>
                        <p class="font-bold text-gray-700 text-xl">wdawd</p>
            ...
            <div class="mt-20 text-center border-b pb-12">
                ...
                <p class="mt-8 text-gray-500">wadwad</p>
                <p class="mt-2 text-gray-500">awdawd</p>
            </div>
            <div class="mt-12 flex flex-col justify-center">
                <p class="text-gray-600 text-center font-light lg:px-16">awdwad</p>
            </div>
        </div>
    </div>
</x-app-layout>
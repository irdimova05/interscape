    ...
    <section class="bg-white ">
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
            ...
            <div class="flex items-center space-x-4">
                ...
                <button type="button" class="inline-flex text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">
